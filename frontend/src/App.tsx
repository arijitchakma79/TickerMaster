    ...
    <div className="app-shell">
      ...
      <nav className="top-nav" aria-label="Primary">
        <div className="top-nav-left">
          <div className="top-nav-brand" aria-label="TickerMaster">
            <img src={brandLogo} alt="" className="top-nav-logo" />
          </div>
        </div>
        <div className="top-nav-right">
          {isAuthConfigured() ? (
            ...
            <span className="muted">Set `VITE_SUPABASE_URL` + `VITE_SUPABASE_ANON_KEY` to enable login.</span>
          )}
